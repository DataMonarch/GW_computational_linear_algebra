...
public class SearchClosest3D extends Application {
	...
	double alphaLow=-100, alphaHigh=100, alphaStep=0.1;
	double betaLow=-100, betaHigh=100, betaStep=0.1;
	...
	// Print out the best y:
	System.out.println ("best y = " + Arrays.toString (bestY));
